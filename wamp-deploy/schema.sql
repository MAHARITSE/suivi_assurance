...
CREATE TABLE IF NOT EXISTS `paiements` (
  ...
  `date_saisie` VARCHAR(100) DEFAULT NULL COMMENT 'Horodatage immuable de l importation ou de la saisie du reglement',
  `societe_id` VARCHAR(100) NOT NULL,
  `societe_nom` VARCHAR(255) DEFAULT NULL,
  `sous_societe` VARCHAR(255) DEFAULT NULL,
  `nom_agent` VARCHAR(255) DEFAULT NULL,
  ...
  KEY `idx_paiements_date_saisie` (`date_saisie`),
