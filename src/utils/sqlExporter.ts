...
export function generateMySQLDump(data: {
  ...
  lines.push(`  \`societe_id\` VARCHAR(64) NOT NULL,`);
  ...
  lines.push(`  \`sous_societe\` VARCHAR(255) DEFAULT NULL,`);
  lines.push(`  \`personne_id\` VARCHAR(64) DEFAULT NULL,`);
  ...
  lines.push(`  \`date_paiement\` VARCHAR(30) DEFAULT NULL,`);
  lines.push(`  \`numero_bordereau\` VARCHAR(100) DEFAULT NULL,`);
  ...
  lines.push(`  \`id\` VARCHAR(64) NOT NULL,`);
  lines.push(`  \`prestation_id\` VARCHAR(64) NOT NULL,`);
  lines.push(`  \`code\` VARCHAR(50) NOT NULL,`);
  ...
  lines.push(`  \`nom_agent\` VARCHAR(255) DEFAULT NULL,`);
  lines.push(`  \`matricule\` VARCHAR(100) DEFAULT NULL,`);
  lines.push(`  \`prestation_id\` VARCHAR(64) DEFAULT NULL,`);
  lines.push(`  \`prestation_numero\` VARCHAR(100) DEFAULT NULL,`);
  lines.push(`  \`mode_paiement\` VARCHAR(50) DEFAULT 'Virement bancaire',`);
  ...
  lines.push(`  \`id\` VARCHAR(64) NOT NULL,`);
  lines.push(`  \`paiement_id\` VARCHAR(64) NOT NULL,`);
  lines.push(`  \`ligne_prestation_id\` VARCHAR(64) DEFAULT NULL,`);
  lines.push(`  \`prestation_id\` VARCHAR(64) DEFAULT NULL,`);
